...
import com.crm.sharedlib.messaging.dto.amqp.OrgUserRoleChangedMessage;
...
import static com.crm.sharedlib.messaging.constants.RabbitMQConstants.ORGANIZATION_USER_ROLE_CHANGE_ROUTING_KEY;
...
public class OrgUserRoleChangedProducer {
    ...
    public void sendOrgUserRoleChanged(
        ...
        OrgUserRoleChangedMessage message = OrgUserRoleChangedMessage.builder()
